...
type DoaUmrahDetailScreenProps = {
  content: GuideDetailContent
  onBack: () => void
}

export function DoaUmrahDetailScreen({ content, onBack }: DoaUmrahDetailScreenProps) {
  return (
    <section className="phone-shell recitation-detail-shell doa-umrah-detail-shell" aria-label={content.title}>
      ...
      <div className="recitation-detail-scroll">
        <section className="recitation-hero-card doa-umrah-hero-card">
        ...
        {content.arabicText ? (
          <section className="recitation-arabic-card doa-umrah-arabic-card">
        ...
        <section className="recitation-meaning-card doa-umrah-meaning-card">
